...
VKAPI_ATTR void VKAPI_CALL CmdBuildAccelerationStructureNVX(
    ...
    const VkLayerDispatchTable *disp = loader_get_dispatch(cmdBuf);
    disp->CmdBuildAccelerationStructureNVX(cmdBuf, type, instanceCount, instanceData, instanceOffset, geometryCount, pGeometries, flags, update, dst, src, scratch, scratchOffset);
}
...
VKAPI_ATTR void VKAPI_CALL CmdCopyAccelerationStructureNVX(
    ...
    const VkLayerDispatchTable *disp = loader_get_dispatch(cmdBuf);
    disp->CmdCopyAccelerationStructureNVX(cmdBuf, dst, src, mode);
}
...
VKAPI_ATTR void VKAPI_CALL CmdTraceRaysNVX(
    ...
    uint32_t                                    height) {
    const VkLayerDispatchTable *disp = loader_get_dispatch(cmdBuf);
    disp->CmdTraceRaysNVX(cmdBuf, raygenShaderBindingTableBuffer, raygenShaderBindingOffset, missShaderBindingTableBuffer, missShaderBindingOffset, missShaderBindingStride, hitShaderBindingTableBuffer, hitShaderBindingOffset, hitShaderBindingStride, width, height);
}
...
VKAPI_ATTR void VKAPI_CALL CmdWriteAccelerationStructurePropertiesNVX(
    ...
    uint32_t                                    query) {
    const VkLayerDispatchTable *disp = loader_get_dispatch(cmdBuf);
    disp->CmdWriteAccelerationStructurePropertiesNVX(cmdBuf, accelerationStructure, queryType, queryPool, query);
}
