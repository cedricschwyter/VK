...
{
    layer_data *dev_data = GetLayerDataPtr(get_dispatch_key(cmdBuf), layer_data_map);
    ...
    dev_data->dispatch_table.CmdBuildAccelerationStructureNVX(cmdBuf, type, instanceCount, instanceData, instanceOffset, geometryCount, (const VkGeometryNVX*)local_pGeometries, flags, update, dst, src, scratch, scratchOffset);
    ...
    VkCopyAccelerationStructureModeNVX          mode)
{
    ...
    dev_data->dispatch_table.CmdCopyAccelerationStructureNVX(cmdBuf, dst, src, mode);
    ...
    uint32_t                                    height)
{
    ...
    dev_data->dispatch_table.CmdTraceRaysNVX(cmdBuf, raygenShaderBindingTableBuffer, raygenShaderBindingOffset, missShaderBindingTableBuffer, missShaderBindingOffset, missShaderBindingStride, hitShaderBindingTableBuffer, hitShaderBindingOffset, hitShaderBindingStride, width, height);
    ...
    uint32_t                                    query)
{
    ...
    dev_data->dispatch_table.CmdWriteAccelerationStructurePropertiesNVX(cmdBuf, accelerationStructure, queryType, queryPool, query);
