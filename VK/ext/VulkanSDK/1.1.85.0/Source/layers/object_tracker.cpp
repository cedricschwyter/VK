    ...
    VkDeviceSize                                scratchOffset)
{
    ...
    {
        std::lock_guard<std::mutex> lock(global_lock);
        skip |= ValidateObject(cmdBuf, cmdBuf, kVulkanObjectTypeCommandBuffer, false, "VUID-vkCmdBuildAccelerationStructureNVX-cmdBuf-parameter", "VUID-vkCmdBuildAccelerationStructureNVX-commonparent");
        skip |= ValidateObject(cmdBuf, instanceData, kVulkanObjectTypeBuffer, true, "VUID-vkCmdBuildAccelerationStructureNVX-instanceData-parameter", "VUID-vkCmdBuildAccelerationStructureNVX-commonparent");
        if (pGeometries) {
            for (uint32_t index0 = 0; index0 < geometryCount; ++index0) {
                skip |= ValidateObject(cmdBuf, pGeometries[index0].geometry.triangles.vertexData, kVulkanObjectTypeBuffer, true, "VUID-VkGeometryTrianglesNVX-vertexData-parameter", "VUID-VkGeometryTrianglesNVX-commonparent");
                skip |= ValidateObject(cmdBuf, pGeometries[index0].geometry.triangles.indexData, kVulkanObjectTypeBuffer, true, "VUID-VkGeometryTrianglesNVX-indexData-parameter", "VUID-VkGeometryTrianglesNVX-commonparent");
                skip |= ValidateObject(cmdBuf, pGeometries[index0].geometry.triangles.transformData, kVulkanObjectTypeBuffer, true, "VUID-VkGeometryTrianglesNVX-transformData-parameter", "VUID-VkGeometryTrianglesNVX-commonparent");
                skip |= ValidateObject(cmdBuf, pGeometries[index0].geometry.aabbs.aabbData, kVulkanObjectTypeBuffer, true, "VUID-VkGeometryAABBNVX-aabbData-parameter", kVUIDUndefined);
            }
        }
        skip |= ValidateObject(cmdBuf, dst, kVulkanObjectTypeAccelerationStructureNVX, false, "VUID-vkCmdBuildAccelerationStructureNVX-dst-parameter", "VUID-vkCmdBuildAccelerationStructureNVX-commonparent");
        skip |= ValidateObject(cmdBuf, src, kVulkanObjectTypeAccelerationStructureNVX, true, "VUID-vkCmdBuildAccelerationStructureNVX-src-parameter", "VUID-vkCmdBuildAccelerationStructureNVX-commonparent");
        skip |= ValidateObject(cmdBuf, scratch, kVulkanObjectTypeBuffer, false, "VUID-vkCmdBuildAccelerationStructureNVX-scratch-parameter", "VUID-vkCmdBuildAccelerationStructureNVX-commonparent");
    }
    if (skip) return;
    GetLayerDataPtr(get_dispatch_key(cmdBuf), layer_data_map)->device_dispatch_table.CmdBuildAccelerationStructureNVX(cmdBuf, type, instanceCount, instanceData, instanceOffset, geometryCount, pGeometries, flags, update, dst, src, scratch, scratchOffset);
    ...
    VkCopyAccelerationStructureModeNVX          mode)
{
    ...
    {
        std::lock_guard<std::mutex> lock(global_lock);
        skip |= ValidateObject(cmdBuf, cmdBuf, kVulkanObjectTypeCommandBuffer, false, "VUID-vkCmdCopyAccelerationStructureNVX-cmdBuf-parameter", "VUID-vkCmdCopyAccelerationStructureNVX-commonparent");
        skip |= ValidateObject(cmdBuf, dst, kVulkanObjectTypeAccelerationStructureNVX, false, "VUID-vkCmdCopyAccelerationStructureNVX-dst-parameter", "VUID-vkCmdCopyAccelerationStructureNVX-commonparent");
        skip |= ValidateObject(cmdBuf, src, kVulkanObjectTypeAccelerationStructureNVX, false, "VUID-vkCmdCopyAccelerationStructureNVX-src-parameter", "VUID-vkCmdCopyAccelerationStructureNVX-commonparent");
    }
    if (skip) return;
    GetLayerDataPtr(get_dispatch_key(cmdBuf), layer_data_map)->device_dispatch_table.CmdCopyAccelerationStructureNVX(cmdBuf, dst, src, mode);
    ...
    uint32_t                                    height)
{
    ...
    {
        std::lock_guard<std::mutex> lock(global_lock);
        skip |= ValidateObject(cmdBuf, cmdBuf, kVulkanObjectTypeCommandBuffer, false, "VUID-vkCmdTraceRaysNVX-cmdBuf-parameter", "VUID-vkCmdTraceRaysNVX-commonparent");
        skip |= ValidateObject(cmdBuf, raygenShaderBindingTableBuffer, kVulkanObjectTypeBuffer, false, "VUID-vkCmdTraceRaysNVX-raygenShaderBindingTableBuffer-parameter", "VUID-vkCmdTraceRaysNVX-commonparent");
        skip |= ValidateObject(cmdBuf, missShaderBindingTableBuffer, kVulkanObjectTypeBuffer, false, "VUID-vkCmdTraceRaysNVX-missShaderBindingTableBuffer-parameter", "VUID-vkCmdTraceRaysNVX-commonparent");
        skip |= ValidateObject(cmdBuf, hitShaderBindingTableBuffer, kVulkanObjectTypeBuffer, false, "VUID-vkCmdTraceRaysNVX-hitShaderBindingTableBuffer-parameter", "VUID-vkCmdTraceRaysNVX-commonparent");
    }
    if (skip) return;
    GetLayerDataPtr(get_dispatch_key(cmdBuf), layer_data_map)->device_dispatch_table.CmdTraceRaysNVX(cmdBuf, raygenShaderBindingTableBuffer, raygenShaderBindingOffset, missShaderBindingTableBuffer, missShaderBindingOffset, missShaderBindingStride, hitShaderBindingTableBuffer, hitShaderBindingOffset, hitShaderBindingStride, width, height);
    ...
    uint32_t                                    query)
{
    ...
    {
        std::lock_guard<std::mutex> lock(global_lock);
        skip |= ValidateObject(cmdBuf, cmdBuf, kVulkanObjectTypeCommandBuffer, false, "VUID-vkCmdWriteAccelerationStructurePropertiesNVX-cmdBuf-parameter", "VUID-vkCmdWriteAccelerationStructurePropertiesNVX-commonparent");
        skip |= ValidateObject(cmdBuf, accelerationStructure, kVulkanObjectTypeAccelerationStructureNVX, false, "VUID-vkCmdWriteAccelerationStructurePropertiesNVX-accelerationStructure-parameter", "VUID-vkCmdWriteAccelerationStructurePropertiesNVX-commonparent");
        skip |= ValidateObject(cmdBuf, queryPool, kVulkanObjectTypeQueryPool, false, "VUID-vkCmdWriteAccelerationStructurePropertiesNVX-queryPool-parameter", "VUID-vkCmdWriteAccelerationStructurePropertiesNVX-commonparent");
    }
    if (skip) return;
    GetLayerDataPtr(get_dispatch_key(cmdBuf), layer_data_map)->device_dispatch_table.CmdWriteAccelerationStructurePropertiesNVX(cmdBuf, accelerationStructure, queryType, queryPool, query);
