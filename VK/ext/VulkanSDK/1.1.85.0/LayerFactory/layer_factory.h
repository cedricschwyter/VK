...
class layer_factory {
    public:
        ...
        virtual VkResult PreCallCreateAccelerationStructureNVX(VkDevice device, const VkAccelerationStructureCreateInfoNVX* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkAccelerationStructureNVX* pAccelerationStructure) { PreCallApiFunction("vkCreateAccelerationStructureNVX"); return VK_SUCCESS; };
        virtual VkResult PostCallCreateAccelerationStructureNVX(VkDevice device, const VkAccelerationStructureCreateInfoNVX* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkAccelerationStructureNVX* pAccelerationStructure) { PostCallApiFunction("vkCreateAccelerationStructureNVX"); return VK_SUCCESS; };
        virtual void PreCallDestroyAccelerationStructureNVX(VkDevice device, VkAccelerationStructureNVX accelerationStructure, const VkAllocationCallbacks* pAllocator) { PreCallApiFunction("vkDestroyAccelerationStructureNVX");};
        virtual void PostCallDestroyAccelerationStructureNVX(VkDevice device, VkAccelerationStructureNVX accelerationStructure, const VkAllocationCallbacks* pAllocator) { PostCallApiFunction("vkDestroyAccelerationStructureNVX");};
        virtual void PreCallGetAccelerationStructureMemoryRequirementsNVX(VkDevice device, const VkAccelerationStructureMemoryRequirementsInfoNVX* pInfo, VkMemoryRequirements2KHR* pMemoryRequirements) { PreCallApiFunction("vkGetAccelerationStructureMemoryRequirementsNVX");};
        virtual void PostCallGetAccelerationStructureMemoryRequirementsNVX(VkDevice device, const VkAccelerationStructureMemoryRequirementsInfoNVX* pInfo, VkMemoryRequirements2KHR* pMemoryRequirements) { PostCallApiFunction("vkGetAccelerationStructureMemoryRequirementsNVX");};
        virtual void PreCallGetAccelerationStructureScratchMemoryRequirementsNVX(VkDevice device, const VkAccelerationStructureMemoryRequirementsInfoNVX* pInfo, VkMemoryRequirements2KHR* pMemoryRequirements) { PreCallApiFunction("vkGetAccelerationStructureScratchMemoryRequirementsNVX");};
        virtual void PostCallGetAccelerationStructureScratchMemoryRequirementsNVX(VkDevice device, const VkAccelerationStructureMemoryRequirementsInfoNVX* pInfo, VkMemoryRequirements2KHR* pMemoryRequirements) { PostCallApiFunction("vkGetAccelerationStructureScratchMemoryRequirementsNVX");};
        virtual VkResult PreCallBindAccelerationStructureMemoryNVX(VkDevice device, uint32_t bindInfoCount, const VkBindAccelerationStructureMemoryInfoNVX* pBindInfos) { PreCallApiFunction("vkBindAccelerationStructureMemoryNVX"); return VK_SUCCESS; };
        virtual VkResult PostCallBindAccelerationStructureMemoryNVX(VkDevice device, uint32_t bindInfoCount, const VkBindAccelerationStructureMemoryInfoNVX* pBindInfos) { PostCallApiFunction("vkBindAccelerationStructureMemoryNVX"); return VK_SUCCESS; };
        virtual void PreCallCmdBuildAccelerationStructureNVX(VkCommandBuffer cmdBuf, VkAccelerationStructureTypeNVX type, uint32_t instanceCount, VkBuffer instanceData, VkDeviceSize instanceOffset, uint32_t geometryCount, const VkGeometryNVX* pGeometries, VkBuildAccelerationStructureFlagsNVX flags, VkBool32 update, VkAccelerationStructureNVX dst, VkAccelerationStructureNVX src, VkBuffer scratch, VkDeviceSize scratchOffset) { PreCallApiFunction("vkCmdBuildAccelerationStructureNVX");};
        virtual void PostCallCmdBuildAccelerationStructureNVX(VkCommandBuffer cmdBuf, VkAccelerationStructureTypeNVX type, uint32_t instanceCount, VkBuffer instanceData, VkDeviceSize instanceOffset, uint32_t geometryCount, const VkGeometryNVX* pGeometries, VkBuildAccelerationStructureFlagsNVX flags, VkBool32 update, VkAccelerationStructureNVX dst, VkAccelerationStructureNVX src, VkBuffer scratch, VkDeviceSize scratchOffset) { PostCallApiFunction("vkCmdBuildAccelerationStructureNVX");};
        virtual void PreCallCmdCopyAccelerationStructureNVX(VkCommandBuffer cmdBuf, VkAccelerationStructureNVX dst, VkAccelerationStructureNVX src, VkCopyAccelerationStructureModeNVX mode) { PreCallApiFunction("vkCmdCopyAccelerationStructureNVX");};
        virtual void PostCallCmdCopyAccelerationStructureNVX(VkCommandBuffer cmdBuf, VkAccelerationStructureNVX dst, VkAccelerationStructureNVX src, VkCopyAccelerationStructureModeNVX mode) { PostCallApiFunction("vkCmdCopyAccelerationStructureNVX");};
        virtual void PreCallCmdTraceRaysNVX(VkCommandBuffer cmdBuf, VkBuffer raygenShaderBindingTableBuffer, VkDeviceSize raygenShaderBindingOffset, VkBuffer missShaderBindingTableBuffer, VkDeviceSize missShaderBindingOffset, VkDeviceSize missShaderBindingStride, VkBuffer hitShaderBindingTableBuffer, VkDeviceSize hitShaderBindingOffset, VkDeviceSize hitShaderBindingStride, uint32_t width, uint32_t height) { PreCallApiFunction("vkCmdTraceRaysNVX");};
        virtual void PostCallCmdTraceRaysNVX(VkCommandBuffer cmdBuf, VkBuffer raygenShaderBindingTableBuffer, VkDeviceSize raygenShaderBindingOffset, VkBuffer missShaderBindingTableBuffer, VkDeviceSize missShaderBindingOffset, VkDeviceSize missShaderBindingStride, VkBuffer hitShaderBindingTableBuffer, VkDeviceSize hitShaderBindingOffset, VkDeviceSize hitShaderBindingStride, uint32_t width, uint32_t height) { PostCallApiFunction("vkCmdTraceRaysNVX");};
        virtual VkResult PreCallCreateRaytracingPipelinesNVX(VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkRaytracingPipelineCreateInfoNVX* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines) { PreCallApiFunction("vkCreateRaytracingPipelinesNVX"); return VK_SUCCESS; };
        virtual VkResult PostCallCreateRaytracingPipelinesNVX(VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkRaytracingPipelineCreateInfoNVX* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines) { PostCallApiFunction("vkCreateRaytracingPipelinesNVX"); return VK_SUCCESS; };
        virtual VkResult PreCallGetRaytracingShaderHandlesNVX(VkDevice device, VkPipeline pipeline, uint32_t firstGroup, uint32_t groupCount, size_t dataSize, void* pData) { PreCallApiFunction("vkGetRaytracingShaderHandlesNVX"); return VK_SUCCESS; };
        virtual VkResult PostCallGetRaytracingShaderHandlesNVX(VkDevice device, VkPipeline pipeline, uint32_t firstGroup, uint32_t groupCount, size_t dataSize, void* pData) { PostCallApiFunction("vkGetRaytracingShaderHandlesNVX"); return VK_SUCCESS; };
        virtual VkResult PreCallGetAccelerationStructureHandleNVX(VkDevice device, VkAccelerationStructureNVX accelerationStructure, size_t dataSize, void* pData) { PreCallApiFunction("vkGetAccelerationStructureHandleNVX"); return VK_SUCCESS; };
        virtual VkResult PostCallGetAccelerationStructureHandleNVX(VkDevice device, VkAccelerationStructureNVX accelerationStructure, size_t dataSize, void* pData) { PostCallApiFunction("vkGetAccelerationStructureHandleNVX"); return VK_SUCCESS; };
        virtual void PreCallCmdWriteAccelerationStructurePropertiesNVX(VkCommandBuffer cmdBuf, VkAccelerationStructureNVX accelerationStructure, VkQueryType queryType, VkQueryPool queryPool, uint32_t query) { PreCallApiFunction("vkCmdWriteAccelerationStructurePropertiesNVX");};
        virtual void PostCallCmdWriteAccelerationStructurePropertiesNVX(VkCommandBuffer cmdBuf, VkAccelerationStructureNVX accelerationStructure, VkQueryType queryType, VkQueryPool queryPool, uint32_t query) { PostCallApiFunction("vkCmdWriteAccelerationStructurePropertiesNVX");};
        virtual VkResult PreCallCompileDeferredNVX(VkDevice device, VkPipeline pipeline, uint32_t shader) { PreCallApiFunction("vkCompileDeferredNVX"); return VK_SUCCESS; };
        virtual VkResult PostCallCompileDeferredNVX(VkDevice device, VkPipeline pipeline, uint32_t shader) { PostCallApiFunction("vkCompileDeferredNVX"); return VK_SUCCESS; };
